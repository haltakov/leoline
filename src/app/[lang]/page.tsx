...
const Home = ({ params: { lang } }: Props) => {
  ...
  const { state } = useConversation({ language: lang, isMicActive, isLongActive, isScaryActive });
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      <LeolineVideo active={state === ConversationState.LISTEN} src="/video/leoline_waiting_1.mp4" />
      <LeolineVideo active={state === ConversationState.RECORD} src="/img/leoline_listening.jpg" />
      <LeolineVideo active={state === ConversationState.TRANSCRIBE} src="/video/leoline_thinking_1.mp4" />
      <LeolineVideo active={state === ConversationState.SPEAK} src="/video/leoline_story_2.mp4" />
