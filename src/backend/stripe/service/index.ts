...
export const createStripeSession = async ({ priceId, baseUrl }: CreateStripeSessionParams) => {
  try {
    ...
    await createLog({ level: "error", message: `Cannot create stripe session: ${error}`, notify: true });
    throw error;
  }
};
...
export const createCustomerPortalSession = async ({ baseUrl }: CreateCustomerPortalSessionParams) => {
  try {
    ...
    await createLog({ level: "error", message: `Cannot create customer portal session: ${error}`, notify: true });
    throw error;
  }
};
...
export const getStripeSubscriptionStatus = async () => {
  try {
    ...
    await createLog({ level: "error", message: `Cannot get stripe subscription status: ${error}`, notify: true });
    throw error;
  }
};
...
export const fulfillSubscription = async (sessionId: string) => {
  try {
    ...
    await createLog({ level: "error", message: `Cannot fulfill subscription: ${error}`, notify: true });
    throw error;
  }
};
